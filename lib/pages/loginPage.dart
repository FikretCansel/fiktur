...
import 'package:fiktur/pages/signUp.dart';
import 'package:fiktur/validation/login_validation.dart';
...
class _LoginPageState extends State<LoginPage> with LoginValidationMixin {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          TextFormField(
              validator: (value)=>isPassword?validatePassword(value!):validateEmail(value!),
              obscureText: isPassword,
              onSaved: (value){
                isPassword?loginForm.password=value!:loginForm.email=value!;
              },
  ...
  handleSubmit() {
    if(_formKey.currentState!.validate()){
      ...
      authService.login(loginForm).then((value) {
        if(value.success){
          ...
          child: Stack(
            children: <Widget>[
              Positioned(
                  ...
                  child: BezierContainer(key: new Key('loginKey'),)),
              Container(
